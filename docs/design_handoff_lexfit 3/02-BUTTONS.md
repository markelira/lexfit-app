...
**Global. Applies to every control in the product.** Numeric values that are not button-specific live in `00-FOUNDATIONS.md` — radius (§0.5), targets (§0.6), interaction states (§0.7), motion (§0.8), icons (§0.11). This file does not restate them.
