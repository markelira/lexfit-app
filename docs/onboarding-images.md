...
- **Composition:** the important subject in the **upper two-thirds** — the bottom
  ...
  above the lower third. Natural light, warm, home setting. **LEXFIT is for everyone
  — cast inclusively (mix of ages, genders, body types); do not skew the imagery to
  one group.**
...
|---|---|---|---|
| welcome | `welcome.jpg` | Someone mid-movement at home, bright morning light, calm space | **A változás otthon kezdődik.** |
| community | `community.jpg` | Several people together — a warm, mixed group energy | A közösség · "1 200+ csoporttag, akik már csinálják." |
| focus | `focus.jpg` | Someone in a targeted move (glutes/core/arms), strong & clean | Minden területre · "Van edzés arra, ahol erősödni akarsz." |
| level | `level.jpg` | Someone training confidently — strength & control | Minden szint · "A szint hozzád igazodik — kezdőtől haladóig." |
| days | `days.jpg` | Weekly-rhythm mood — mat, clean surface, a calm routine feel | A heted · "Heti 5 edzés, napi 30 perc." |
| player | `player.jpg` | A phone/tablet showing the workout video, someone following at home | A lejátszó · "Hang nélkül is végigvezet — TV-re is." |
| env | `env.jpg` | A small home corner with a mat — apartment-friendly | Minden helyzetre · "Bármi is az — van rá változat." |
| alone | `alone.jpg` | Someone resting/contemplative but not giving up (emotional) | Nem vagy egyedül · "Egyedül nehéz. Együtt muszáj." |
| story | `story.jpg` | **Alexa** portrait — natural, close, the founder | Az alapító · "„Egyedül nem megy.” — Alexa" |
| promise | `promise.jpg` | Someone after a workout — satisfied, confident (plan ready) | A terved kész · "Innentől együtt csináljuk." |
