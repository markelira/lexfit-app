...
7. ~~**Company/legal data**~~ ✅ ANSWERED 2026-08-08: AM Studios Group Kft., 3532 Miskolc, Miklós utca 17. 2. em. 26. ajtó, adószám 33004312-1-05, cégjegyzékszám 05 09 039717 (Miskolci Törvényszék Cégbírósága), info@amstudios.hu. ⚠️ OPEN SUB-ITEM: adószám ÁFA code "1" suggests **alanyi adómentes** — conflicts with the 27% ÁFA assumption in `src/lib/pricing/invoice.ts` + pricing docs; owner to confirm with accountant; if AAM, switch Billingo invoices to AAM before the Phase 7 live smoke test.
